...
/*    public Set<String> getKeywords() {
    ...
    public CommandResult execute() {
        final List<ReadOnlyPerson> personsFound = getPersonsTaggedWithKeyword(keywords);
...
*/
    ...
    /*
    private List<ReadOnlyPerson> getPersonsTaggedWithKeyword(Set<String> keywords) {
